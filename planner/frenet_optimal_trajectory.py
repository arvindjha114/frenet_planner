...
def calc_frenet_paths(c_speed, c_d, c_d_d, c_d_dd, s0):
    ...
    for di in np.arange(-MAX_ROAD_WIDTH, MAX_ROAD_WIDTH, D_ROAD_W):
	    ...
	    # quntic_polynomial(start pos, start vel, start accn, end pos, end vel, end accn, time_end)
            ...
            fp.d_ddd = [lat_qp.calc_third_derivative(t) for t in fp.t] # JERK
            ...
            for tv in np.arange(TARGET_SPEED - D_T_S * N_S_SAMPLE, TARGET_SPEED + D_T_S * N_S_SAMPLE, D_T_S):
                ...
                tfp.s_ddd = [lon_qp.calc_third_derivative(t) for t in fp.t]# LONGITUDINAL JERK
...
def main():
    ...
    # x-cord, y-cord, yaws, curvatures, csp
